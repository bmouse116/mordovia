    ...
    <div class="main-page">
        ...
        <div class="search-overlay" v-if="searchVisible">
            <div class="search-container">
                                ...
                                <div class="img">
                                    <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                                        ...
                                        <path
                                            ...
                                            fill="#C3B6BE" stroke="#C3B6BE" />
                                    </svg>
                                </div>
                                <span>{{ tenant.title }}</span>
                            </div>
                        </template>
                        <div class="no-results" v-else-if="searchQuery || searchQuery === ''">
                ...
                <div class="keyboard">
                    <Keyboard @close="handleCloseSearch" @keypress="keyPress" @backspace="backspacePress"></Keyboard>
                </div>
            </div>
        </div>
    </div>
...
//     if (filteredTenants.value.length > 0) {
//         console.log('First result:', filteredTenants.value[0]);
//     }
// };
